...
const REMIX_IDEAS = [
    "to design a movie poster.",
    "to create a fashion magazine cover.",
    "to visualize a new product advertisement.",
    "to generate a character concept for a game.",
    "to place a person into a famous painting.",
    "to create a custom album cover.",
];
